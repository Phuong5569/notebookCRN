...
urlpatterns = [
    ...
    path("api/milvus/", views.send_milvus, name="send_milvus"),
    path('segment-lines/', views.segment_lines_view, name='segment_lines'),
    path('extract-text/', views.extract_text_from_image, name='extract_text'),
    path('model/on/', views.model_on, name='model_on'),
    path('model/off/', views.model_off, name='model_off'),
